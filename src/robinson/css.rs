...
impl Value {
    ...
    /// return the nanoVG color for a value, or black for non-colors.
    pub fn to_color(&self) -> nanovg::Color {
        match *self {
            Color(r,g,b,a) => nanovg::Color::rgba(r,g,b,a),
            _ => nanovg::Color::rgba(0,0,0,255)
        }
    }
}
